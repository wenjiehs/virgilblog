    ...
    sidebar: {
      '/posts/': [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: '这周，我开始把一整件工作交给 Codex', link: '/posts/2026/codex-took-over-my-work-week' },
            { text: '产品经理到构建者：用 Codex 跑通 Agent Runtime', link: '/posts/2026/product-manager-to-builder-with-codex' },
            { text: 'Codex 长期记忆：Obsidian + 插件实践', link: '/posts/2026/codex-obsidian-memory-plugin' },
